    ...
    <div class="p-4 card-body">
        ...
        <form class="row g-3" method="POST" id="myForm" wire:submit.prevent="save" enctype="multipart/form-data">
            ...
            <div class="form-group col-md-3" wire:ignore>
                ...
                <select id="exporting_country" name="exporting_country" data-component-id="{{ $this->getId() }}"
                    data-pharaonic="select2" wire:model="exporting_country"
            ...
            <div class="form-group col-md-3">
                ...
                <select id="item_list" wire:model="item_list"
                    class="form-control rounded-lg @error('item_list') is-invalid @enderror">
...
<script>
    document.addEventListener('livewire:load', () => {
        ...
        $('#exporting_country').select2({
            placeholder: "Select Exporting Country",
            allowClear: true
        });
        $('#exporting_country').on('change', function () {
            @this.set('exporting_country', $(this).val());
        });
        ...
        input.addEventListener('keydown', function (event) {
            ...
            if (event.key === ' ') {
                event.preventDefault();
                @this.call('addNumberOfItems', input.value.trim());
                input.value = '';
            }
        });
    });
