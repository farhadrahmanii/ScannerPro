<div class="card">
    <div class="p-4 card-body">
        ...
        <form class="row g-3" method="POST" id="myForm" enctype="multipart/form-data">
            ...
            <div class="form-group col-md-3">
                ...
                <input type="text" id="goods_id" wire:model="goods_id" name="goods_id"
                    value="{{ $transaction->goods_id }}" class="form-control rounded-lg
                    @error('goods_id')
                        in-valid
                    @enderror
            ...
            <div class="form-group col-md-3">
                ...
                <input type="text" id="exporting_country" wire:model="exporting_country" name="exporting_country"
                    value="{{ $transaction->exporting_country }}" class="form-control rounded-lg
            ...
            <div class="form-group col-md-3">
                ...
                <input type="text" id="production_origin" wire:model="production_origin"
                    value="{{ $transaction->production_origin}}" name="production_origin" class="form-control rounded-lg
            ...
            <div class="form-group col-md-3">
                ...
                <input type="text" id="total_tonnage" wire:model="total_tonnage" value="{{$transaction->total_tonnage}}" name="total_tonnage" class="form-control rounded-lg
                    @error('total_tonnage')
                        in-valid
                    @enderror
            ...
            <div class="form-group col-md-3">
                ...
                <input type="text" id="number_of_items" wire:model="number_of_items" name="number_of_items" value="{{$transaction->number_of_items}}" class="form-control rounded-lg
            ...
            <div class="form-group col-md-3">
                ...
                <input type="text" id="consignee_company" wire:model="consignee_company" name="consignee_company" value="{{$transaction->consignee_company}}" class="form-control rounded-lg
            ...
            <div class="form-group col-md-3">
                ...
                <input type="text" wire:model="consignee_company_tin" name="consignee_company_tin" value="{{$transaction->consignee_company_tin}}" class="form-control rounded-lg
            ...
            <div class="form-group col-md-3">
                ...
                <input type="text" id="input1" wire:model="item_list" name="item_list" value="{{$transaction->item_list}}" class="form-control rounded-lg
                    @error('item_list')
                        in-valid
                    @enderror
            ...
            <div class="form-group col-md-3">
                ...
                <input type="text" id="delivery_location" wire:model="delivery_location" name="delivery_location" value="{{$transaction->delivery_location}}" class="form-control rounded-lg
    ...
    <div class="form-check form-switch form-check-success">
        <input 
            class="form-check-input @error('scan_status') is-invalid @enderror"
            type="checkbox" 
            role="switch" 
            id="scan_status" 
            wire:model="scan_status"
            {{ $transaction->scan_status ? 'checked' : '' }}
        >
    ...
    @enderror
            ...
            <div class="form-group col-md-3">
                ...
                <input type="datetime-local" id="scan_time" wire:model="scan_time" name="scan_time" value="{{$transaction->scan_time}}" class="form-control rounded-lg
                    @error('scan_time')
                        in-valid
                    @enderror
                    " id="scan_time" >
