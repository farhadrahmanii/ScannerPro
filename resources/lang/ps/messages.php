...
return [
    ...
    'National ID' => 'ملي پیژندپاڼه',
    'Contact Information' => 'د اړیکې معلومات',
    'Nationality' => 'تابعیت',
    'Select Nationality' => 'تابعیت وټاکئ',
    'Transport Company TIN' => 'د ترانسپورت شرکت TIN',
    'Add New Transport Company' => 'نوی ترانسپورت شرکت اضافه کړئ',
    'Company Name' => 'د شرکت نوم',
    'Add Transport Company' => 'ترانسپورت شرکت اضافه کړئ',
